...
{
    public class CDestrezaPasantia : CSqlvars
    {
        public CDestrezaPasantia(string ConexionData)
        {
            _ConexionData = ConexionData;
        }

        public ClsDataSets.DS_TB_EMP Detalle(int Id, int IdPasantia, int IdDestreza, string UsuaCrea,
            DateTime FechCrea, string UsuaActu, DateTime FechActu, int OpcionConsulta)
        {
            DS_TB_EMP objDataSet = new DS_TB_EMP();

            try
            {
                ObjConnection = new SqlConnection(_ConexionData);
                ObjAdapter = new SqlDataAdapter("SP_TB_DESTREZA_PASANTIA_GetByAll", ObjConnection);
                ...
                ObjAdapter.SelectCommand.Parameters.AddWithValue("@ID_DESTREZA", IdDestreza);
                ...
                ObjAdapter.Fill(objDataSet, "TB_DESTREZA_PASANTIA");
        ...
        public DataQuery Actualizacion(int Id, int IdPasantia, int IdDestreza, 
           string LoginUsuario, TipoActualizacion OpcionActualizacion)
        {
            ...
            try
            {
                ...
                ObjCommand.Parameters.AddWithValue("@ID_DESTREZA", IdDestreza);
