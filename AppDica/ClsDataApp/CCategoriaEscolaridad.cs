...
{
    public class CCategoriaEscolaridad : CSqlvars
    {
        public CCategoriaEscolaridad(string ConexionData)
        {
             ...
             string UsuaCrea, DateTime FechCrea, string UsuaActu, DateTime FechActu, int OpcionConsulta)
        {
            ...
            try
            {
                ...
                ObjAdapter = new SqlDataAdapter("SP_TBC_CATEGORIA_ESCOLARIDAD_GetByAll", ObjConnection);
                ...
                ObjAdapter.Fill(objDataSet, "TBC_CATEGORIA_ESCOLARIDAD");
        ...
        public DataQuery Actualizacion(int Id, string Escolaridad, string Descripcion, char Estado,
