...
{
    public class CMunicipio : CSqlvars
    {
        public CMunicipio(string ConexionData)
        {
            _ConexionData = ConexionData;
        }

        public ClsDataSets.DS_TBC Detalle(int Id, int IdDepartamento,
            string UsuaCrea, DateTime FechCrea, string UsuaActu, DateTime FechActu, int OpcionConsulta)
        {
            ...
            try
            {
                ...
                ObjAdapter = new SqlDataAdapter("SP_TBC_MUNICIPIO_GetByAll", ObjConnection);
                ...
                ObjAdapter.Fill(objDataSet, "TBC_MUNICIPIO");
        ...
        public DataQuery Actualizacion(int Id, int IdDepartamento, int OpcionConsulta, string LoginUsuario, TipoActualizacion OpcionActualizacion)
        {
