...
namespace ClsDataApp
{
    public class CPasantia : CSqlvars
    {
        ...
        public ClsDataSets.DS_TB_EMP Detalle(int Id, string NombreEva, string EmailContacto, int IdEmpresa, int IdArea,string NombrePasantia ,string Pasantia, DateTime FechPasantia,
           ...
           string Sucursal, string SucursalDireccion, string UsuaCrea, DateTime FechCrea, string UsuaActu, DateTime FechActu, int OpcionConsulta)
        {
             ...
             try
             {
                ...
                ObjAdapter.SelectCommand.Parameters.AddWithValue("@NOMBRE_PASANTIA", NombrePasantia);
        ...
        public DataQuery Actualizacion(int Id, string NombreEva, string EmailContacto, int IdEmpresa, int IdArea,string NombrePasantia, string Pasantia, DateTime FechPasantia,
           string Duracion, string HorarioDe, string HorarioA, char EstadoPasantia, int DiasDe, int DiasA, int EdadDe, int EdadA, int Vacantes,
            string Sucursal,string SucursalDireccion, string LoginUsuario, TipoActualizacion OpcionActualizacion)
        {
            ...
            try
            {
                ...
                ObjCommand.Parameters.AddWithValue("@NOMBRE_PASANTIA", NombrePasantia);
