...
{
    public class CTituloAcademico : CSqlvars
    {
        public CTituloAcademico(string ConexionData)
        {
            _ConexionData = ConexionData;
        }

        public ClsDataSets.DS_TBC Detalle(int Id, string Titulo, string Descripcion,
            string UsuaCrea, DateTime FechCrea, string UsuaActu, DateTime FechActu, int OpcionConsulta)
        {
            ...
            try
            {
                ...
                ObjAdapter = new SqlDataAdapter("SP_TBC_TITULO_ACADEMICO_GetByAll", ObjConnection);
                ObjParam = new SqlParameter();
                ObjAdapter.SelectCommand.CommandType = CommandType.StoredProcedure;

                ObjAdapter.SelectCommand.Parameters.AddWithValue("@ID", Id);
                ObjAdapter.SelectCommand.Parameters.AddWithValue("@DS_TITULO", Titulo);
                ...
                ObjAdapter.Fill(objDataSet, "TBC_TITULO_ACADEMICO");
        ...
        public DataQuery Actualizacion(int Id, string Titulo, string Descripcion,
             int OpcionConsulta, string LoginUsuario, TipoActualizacion OpcionActualizacion)
        {
            ...
            try
            {
                ...
                ObjCommand.Parameters.AddWithValue("@DS_TITULO", Titulo);
