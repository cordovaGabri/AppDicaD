...
{
    public class CEscolaridad : CSqlvars
    {
        public CEscolaridad(string ConexionData)
        {
            _ConexionData = ConexionData;
        }

        public ClsDataSets.DS_TBC Detalle(int Id,int IdCategoriaEscolaridad, string Escolaridad, 
            string UsuaCrea, DateTime FechCrea, string UsuaActu, DateTime FechActu, int OpcionConsulta)
        {
            ...
            try 
            {
                ...
                ObjAdapter = new SqlDataAdapter("SP_TBC_ANIO_ESCOLARIDAD_GetByAll", ObjConnection);
                ...
                ObjAdapter.SelectCommand.Parameters.AddWithValue("@DS_ANIO", Escolaridad);
                ...
                ObjAdapter.Fill(objDataSet, "TBC_ANIO_ESCOLARIDAD");
        ...
        public DataQuery Actualizacion(int Id, int IdCategoriaEscolaridad, string Escolaridad, 
            int OpcionConsulta, string LoginUsuario, TipoActualizacion OpcionActualizacion)
        {
            ...
            try
            {
                ...
                ObjCommand.Parameters.AddWithValue("@DS_ANIO", Escolaridad);
