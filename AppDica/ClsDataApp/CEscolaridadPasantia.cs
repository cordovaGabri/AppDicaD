...
{
    public class CEscolaridadPasantia : CSqlvars
    {
        public CEscolaridadPasantia(string ConexionData)
        {
            ...
            string UsuaCrea, DateTime FechCrea, string UsuaActu, DateTime FechActu, int OpcionConsulta)
        {
            ...
            try
            {
                ...
                ObjAdapter = new SqlDataAdapter("SP_TB_ESCOLARIDAD_PASANTIA_GetByAll", ObjConnection);
                ...
                ObjAdapter.Fill(objDataSet, "TB_ESCOLARIDAD_PASANTIA");
