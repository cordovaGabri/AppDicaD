...
{
    public class CActividadEconomica : CSqlvars
    {
        public CActividadEconomica(string ConexionData)
        {
            _ConexionData = ConexionData;
        }

        public ClsDataSets.DS_TBC Detalle(int Id, string ActividadEco, 
            string UsuaCrea, DateTime FechCrea, string UsuaActu, DateTime FechActu, int OpcionConsulta)
        {
            ...
            try
            {
                ...
                ObjAdapter = new SqlDataAdapter("SP_TBC_ACTIVIDAD_ECONOMICA_GetByAll", ObjConnection);
                ObjParam = new SqlParameter();
                ObjAdapter.SelectCommand.CommandType = CommandType.StoredProcedure;

                ObjAdapter.SelectCommand.Parameters.AddWithValue("@ID", Id);
                ObjAdapter.SelectCommand.Parameters.AddWithValue("@DS_ACT_ECO", ActividadEco);
                ...
                ObjAdapter.Fill(objDataSet, "TBC_ACTIVIDAD_ECONOMICA");
        ...
        public DataQuery Actualizacion(int Id,  string ActividadEco,
                     int OpcionConsulta, string LoginUsuario, TipoActualizacion OpcionActualizacion)
        {
            ...
            try
            {
                ...
                ObjCommand.Parameters.AddWithValue("@DS_ACT_ECO", ActividadEco);
