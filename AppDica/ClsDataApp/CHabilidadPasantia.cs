...
{
    public class CHabilidadPasantia : CSqlvars
    {
        public CHabilidadPasantia(string ConexionData)
        {
            _ConexionData = ConexionData;
        }

        public ClsDataSets.DS_TB_EMP Detalle(int Id, int IdPasantia, int IdHabilidad, int IdNivel,
            string UsuaCrea, DateTime FechCrea, string UsuaActu, DateTime FechActu, int OpcionConsulta)
        {
            ...
            try
            {
                ...
                ObjAdapter = new SqlDataAdapter("SP_TB_PASANTIA_HABILIDAD_GetByAll", ObjConnection);
                ...
                ObjAdapter.SelectCommand.Parameters.AddWithValue("@ID_HABILIDAD_CONOCIMIENTO", IdHabilidad);
                ...
                ObjAdapter.Fill(objDataSet, "TB_PASANTIA_HABILIDAD");
