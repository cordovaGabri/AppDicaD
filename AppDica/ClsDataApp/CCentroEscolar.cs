...
{
    public class CCentroEscolar : CSqlvars
    {
        public CCentroEscolar(string ConexionData)
        {
            _ConexionData = ConexionData;
        }

        public ClsDataSets.DS_TBC Detalle(int Id, string Institucion, string Descripcion,
            string UsuaCrea, DateTime FechCrea, string UsuaActu, DateTime FechActu, int OpcionConsulta)
        {
            ...
            try
            {
                ...
                ObjAdapter = new SqlDataAdapter("SP_TBC_CENTRO_ESCOLAR_GetByAll", ObjConnection);
                ObjParam = new SqlParameter();
                ObjAdapter.SelectCommand.CommandType = CommandType.StoredProcedure;

                ObjAdapter.SelectCommand.Parameters.AddWithValue("@ID", Id);
                ObjAdapter.SelectCommand.Parameters.AddWithValue("@DS_CENTRO_ESCOLAR", Institucion);
                ...
                ObjAdapter.Fill(objDataSet, "TBC_CENTRO_ESCOLAR");
        ...
        public DataQuery Actualizacion(int Id, string Institucion, string Descripcion,
            int OpcionConsulta, string LoginUsuario, TipoActualizacion OpcionActualizacion)
        {
            ...
            try
            {
                ...
                ObjCommand.Parameters.AddWithValue("@DS_CENTRO_ESCOLAR", Institucion);
